...
total_budget=200000
leverage_feature=key_value_lowdim_concat # [key, key_value, key_value_lowdim_concat]
...
output_dir="${workdir}/eval_results/mv_recon/S${model_name}_${max_frames}_termProject${leverage_ridge_dim}_a${layer_budget_alpha}_TopK_ridge${leverage_ridge_lambda}_noCrop_icpvox${icp_voxel_size}_confDepth_init${leverage_conf_gate_init}_norm_kvLowConcat"
echo "$output_dir"
...
accelerate launch --num_processes 2 --main_process_port 29402 ./eval/mv_recon/launch.py \
