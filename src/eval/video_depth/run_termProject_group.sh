...
history_anchor_patch_topk_per_frame=0
...
for data in "${datasets[@]}"; do
    output_dir="${workdir}/eval_results/video_depth/${data}_${model_name}_termProject_group${history_anchor_patch_topk_per_frame}"
    echo "$output_dir"
