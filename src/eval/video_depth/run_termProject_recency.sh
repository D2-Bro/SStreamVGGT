...
leverage_dpp_diversity_beta=0.5
...
history_anchor_patch_topk_per_frame=16

leverage_dpp_recency_lambda=0.5
leverage_dpp_recency_window=10
leverage_dpp_recency_gate_power=0.2

for data in "${datasets[@]}"; do
    output_dir="${workdir}/eval_results/video_depth/${data}_${model_name}_termProject_recency_${leverage_dpp_recency_lambda}_histCamMove_maxA${max_anchors}_patchTop${history_anchor_patch_topk_per_frame}"
    echo "$output_dir"
