...
layer_budget_strategy='covariance_pr'  # [leverage_pr, uniform, value_weighted_leverage_pr, cosine_precomputed, covariance_pr, hybrid_cap, hybrid_geom ]
