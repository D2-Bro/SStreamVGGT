...
layer_budget_strategy='value_weighted_leverage_pr' # [leverage_pr, uniform, leverage_entropy, value_weighted_leverage_pr, depth_weighted_leverage_pr]
...
datasets=('kitti_s1_500' 'bonn_500') # ['kitti_s1_500', 'bonn_500']
...
for data in "${datasets[@]}"; do
    output_dir="${workdir}/eval_results/video_depth/${data}_${model_name}_${max_frames}_termProject${leverage_ridge_dim}_a${layer_budget_alpha}_TopK_confDepth_norm_${layer_budget_strategy}${layer_budget_depth_mu}${layer_budget_depth_sigma}"
    echo "$output_dir"
    ...
    accelerate launch --num_processes 1 ../src/eval/video_depth/launch.py \
        ...
        --leverage_score_histogram_max 0.1 \
