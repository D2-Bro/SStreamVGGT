...
# ReplicaMultiagent is read virtually: scene/part1 + scene/part2 are concatenated
# in pose_evaluation metadata without creating merged files on disk.
export SSTREAMVGGT_REPLICA_MULTIAGENT_ROOT="${SSTREAMVGGT_REPLICA_MULTIAGENT_ROOT:-/home/dongjae/data/ReplicaMultiagent}"

eval_dataset="replica_multiagent"
